      ...
      <div className="flex-1 overflow-y-auto py-3 px-3 space-y-5 scrollbar-thin">
        ...
        <div>
          ...
          <button
            ...
            className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-xl font-semibold text-[13px] transition-all ${
              isIGActive
                ? isDark
          ...
          >
            <div className={`w-6 h-6 rounded-lg flex items-center justify-center ${isIGActive ? 'bg-gradient-to-br from-pink-500 to-purple-600' : isDark ? 'bg-slate-700' : 'bg-slate-100'}`}>
